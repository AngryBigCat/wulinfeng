                ...
                return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(u, function(e, a) {
                    ...
                    0 !== a.length && (r || (a[d.config.indexName] = e), c.eachCols(function(e, r) {
                        ...
                        if (void 0 !== c && null !== c || (c = ""), !(r.colspan > 1)) {
                            ...
                            function() {
                                var e = [];
                                // 添加自定义属性 editable,edittype
                                return r.edit && e.push(' data-edit="true"'), r.align && e.push(' align="' + r.align + '"') , r.editable && e.push(' editable="' + r.editable + '"'), r.edittype && e.push(' edittype="' + r.edittype + '"'), r.templet && e.push(' data-content="' + c + '"'), r.toolbar && e.push(' data-off="true"'), r.event && e.push(' lay-event="' + r.event + '"'), r.style && e.push(' style="' + r.style + '"'), e.join("")
