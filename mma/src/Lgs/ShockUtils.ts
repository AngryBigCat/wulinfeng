module Lgs {
	...
	export class ShockUtils
	{
		...
		private posScale:number = 1.5;
		private mapPoss:Array<any> = [new egret.Point(0*this.posScale,3*this.posScale),new egret.Point(3*this.posScale,2*this.posScale),new egret.Point(-3*this.posScale,-2*this.posScale)];
		private spritePoss:Array<any> = [new egret.Point(5*this.posScale,0*this.posScale),new egret.Point(-5*this.posScale,0*this.posScale),new egret.Point(5*this.posScale,0*this.posScale)];
